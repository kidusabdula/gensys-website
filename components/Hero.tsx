    ...
    <section className="h-screen overflow-hidden relative">
      ...
      <div className="">
        <Image
          ...
          quality={100}
        />
        <div className="absolute inset-0 bg-[#1E3A8A] opacity-70"></div> {/* Deep blue shade overlay (#1E3A8A) */}
      </div>

      {/* Hero Content */}
      <div className="relative container mx-auto h-full flex items-center justify-center text-center px-5 z-0">
